<?php
    ...
    //find if allowed and new price
        ...
        if (($_POST["quantity"] * $tmp["price"]) > $coverage) apologize("Sorry, enought fund.");
    ...
    // add item to portfolio (or insert a new one)            
        cs50::query("INSERT INTO portfolios (id, symbol, name, price, shares) 
            ...
            $_SESSION["id"], $_POST["symbol"], $tmp["name"], $tmp["price"]*$_POST["quantity"], $_POST["quantity"] ,$_POST["quantity"]); 
